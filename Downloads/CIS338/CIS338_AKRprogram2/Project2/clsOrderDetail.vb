Public Class clsOrderDetail
    ...
    'This class has the properties for the Order details
    'All of the validation of each detail is in this class
    ...
    Private Function isValidItem(ByVal s As String) As Boolean
        ...
        Catch ex As Exception
            addError("Line" & iLine & ":Item: Invalid Item")
        End Try
    ...
    Private Function isValidQty(ByVal s As String) As Boolean
        ...
        Try
            If (Integer.TryParse(s, tmp) AndAlso tmp >= 1) Then
                bResult = True
            Else
                addError("Line:" & iLine & ":Qty: Invalid Quantity format")
                bResult = False
            End If
        Catch ex As Exception
